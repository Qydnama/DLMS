...
export const SettingsPopover: React.FC = () => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent side="bottom" align="center" sideOffset={20} className="font-[800] bg-white p-2 rounded-xl shadow-xl w-[180px] space-y-2">
        {/* Theme Selector */}
        <div>
          <div className="space-y-1">
            ...
            <div className="">
                <p className="pl-2 text-sm text-gray-800 mb-2">{t("theme")}</p>
                <button
                className={`flex items-center justify-between w-full px-3 py-2 text-sm rounded-md ${
                    theme === "system" ? "bg-gray-100 text-blue-500" : "hover:bg-gray-100"
                }`}
                ...
                <button
                className={`flex items-center justify-between w-full px-3 py-2 text-sm rounded-md ${
                    theme === "dark" ? "bg-gray-100 text-blue-500" : "hover:bg-gray-100"
                }`}
                ...
                <button
                className={`flex items-center justify-between w-full px-3 py-2 text-sm rounded-md ${
                    theme === "light" ? "bg-gray-100 text-blue-500" : "hover:bg-gray-100"
                }`}
        ...
        {/* Language Selector */}
        <div className="p-2">
          <p className="text-sm text-gray-800 mb-2">{t("language")}</p>
