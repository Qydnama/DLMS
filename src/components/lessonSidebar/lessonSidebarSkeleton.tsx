...
export function LessonSidebarSkeleton() {
  ...
  return (
    <div className="bg-white m-0 rounded-[2vw]">
      <Sidebar collapsible={isMobile ? "icon" : "none"} className="bg-white rounded-[2vw]">
        {/* Sidebar Header */}
            ...
            <SidebarMenu>
              <ScrollArea className="h-[700px]">
                {[...Array(3)].map((_, moduleIndex) => (
                  <div key={moduleIndex} className="mt-4 w-[272px] lg:w-[240px] space-y-2">
                    {/* Module title */}
                    <SidebarMenuItem>
                    ...
                    {[...Array(4)].map((_, lessonIndex) => (
                      <SidebarMenuItem key={lessonIndex} className="pl-3">
