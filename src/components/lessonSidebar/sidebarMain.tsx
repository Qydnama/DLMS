        ...
        <SidebarMenu className="">
          ...
          <ScrollArea className="h-[700px]">
            {modules.map((module, moduleIndex) => (
              <div key={moduleIndex} className="mt-2 w-[272px] lg:w-[240px]">
                {/* Module Title */}
                  ...
                  return (
                    <SidebarMenuItem
                      ...
                      className={`pl-3 text-sm group truncate ${
                        isActive ? "underline underline-offset-[3px] rounded-lg" : "text-gray-600 hover:text-black"
                      }`}
                    >
                      <SidebarMenuButton asChild>
                        <a href={lesson.id} className="flex items-center w-full py-2 px-3 truncate">
                          {isActive && (
